...
namespace AMAssos.Controllers
{
    public class AssociationsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            AssociationDetailViewModel associationDetailViewModel = new AssociationDetailViewModel();
            associationDetailViewModel.Association = association;
            associationDetailViewModel.Sorties = association.Sorties.GroupBy(p => p.IdAssociation.ToString()).ToDictionary(t => t.Key, t => t.ToList());


            return View(associationDetailViewModel);
        }
